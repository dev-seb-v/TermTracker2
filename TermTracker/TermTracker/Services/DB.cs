...
namespace TermTracker.Services
{
	public static class DB
	{
		...
		public static void LoadData()
		{
			...
			AddObjAssessment(1, "Midterm Exam", "Study Chapter on Pruning", due);
			AddPerfAssessment(1, "Prune a Hawthorn", "Study Chapter 11", due);
		}

		//generic method for practice
		...
		#region Objective Assessment methods
		...
		#region Performance Assessment methods
